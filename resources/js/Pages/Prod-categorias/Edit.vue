<template>
    ...
    <AuthenticatedLayout>
        ...
        <div  class="mt-1 mb-1 grid justify-items-end p-1 border-b border-gray-200 ">
            <Link :href="route('prod-categorias.index')" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                <form @submit.prevent="$event => form.patch(route('prod-categorias.update', prodcategoria))" >
                    <div class="mt-4 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <InputLabel for="codigo" value="Código" />
                        <div class="mt-2">
                            <TextInput id="codigo" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" v-model="form.codigo" required autofocus autocomplete="codigo" />
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <TextInput id="name" type="text" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" v-model="form.name" required  autocomplete="name" />
...
const props = defineProps({ 
    errors: { type: Object },
    prodcategoria: {type:Object},
    empresas: {type:Object}
});
const form = useForm({
    codigo: props.prodcategoria.codigo,
    name: props.prodcategoria.name,
    descripcion: props.prodcategoria.descripcion,
    empresa_id:props.prodcategoria.empresa_id
});
</script>