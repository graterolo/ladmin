    ...
    <AuthenticatedLayout>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                <form @submit.prevent="$event => form.patch(route('prod-unidads.update', produnidad))" >
...
const props = defineProps({ 
    errors: { type: Object },
    produnidad: {type:Object},
    empresas: {type:Object}
});
const form = useForm({
    name: props.produnidad.name,
    descripcion: props.produnidad.descripcion,
    empresa_id:props.produnidad.empresa_id
});
</script>