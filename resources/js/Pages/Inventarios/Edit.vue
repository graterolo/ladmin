    ...
    <AuthenticatedLayout>
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                <form @submit.prevent="$event => form.patch(route('inventarios.update', inventario))" >
...
const form = useForm({
    empresa_id: props.inventario.empresa_id,
    deposito_id: props.inventario.deposito_id,
    producto_id: props.inventario.producto_id,
    cantidad:props.inventario.cantidad,
    activo:props.inventario.activo,
    limite_stock:props.inventario.limite_stock
});
</script>