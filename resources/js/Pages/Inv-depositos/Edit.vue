<template>
    ...
    <AuthenticatedLayout>
        ...
        <div  class="mt-1 mb-1 grid justify-items-end p-1 border-b border-gray-200 ">
            <Link :href="route('inv-depositos.index')" 
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 border-b border-gray-200">
                <form @submit.prevent="$event => form.patch(route('inv-depositos.update', invdeposito))" >
                  <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-3">
                        ...
                        <div class="mt-2">
                            <select id="condicion" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" v-model="form.condicion" required>
...
const props = defineProps({ 
    errors: { type: Object },
    invdeposito: {type:Object},
    empresas: {type:Object}
});
const form = useForm({
    name: props.invdeposito.name,
    acronimo: props.invdeposito.acronimo,
    tipo: props.invdeposito.tipo,
    condicion: props.invdeposito.condicion,
    descripcion: props.invdeposito.descripcion,
    empresa_id:props.invdeposito.empresa_id
});
</script>